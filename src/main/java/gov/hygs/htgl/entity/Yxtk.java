 ...
 * @version $Id$
 */
public class Yxtk implements Serializable {
	...
	public Collection<Yxtkxzx> getDaxzx() {
		return daxzx;
	}

	public void setDaxzx(Collection<Yxtkxzx> daxzx) {
		this.daxzx = daxzx;
	}

	public Collection<Yxtkxzx> getYxtkxzx() {
		return yxtkxzx;
	}
